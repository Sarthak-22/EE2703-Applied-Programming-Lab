# -*- coding: utf-8 -*-
"""
Created on Wed Feb 24 14:32:05 2021
...
def enggToMath(enggNumber):
    try:
        ...
        # Mega
            ...
            sys.exit("Please check the given component values.")

if __name__ == "__main__":
    # checking number of command line arguments
    if len(sys.argv)!=2 :
        sys.exit("Number of arguments Invalid!")
    else:
        try:
                ...
                try:
                    ...
                    for line in circuitBody:
                        ...
                        # Voltage Source
                            ...
                            if len(lineTokens) == 5: # DC Source
                                ...
                                if circuitFreq == 1e-100:
                                    sys.exit("AC Source frequency not specified!!")
                        ...
                        # Erroneous Component Name
                            ...
                            sys.exit("Wrong Component Given!")
                    try:
                    ...
                    matrixM = np.zeros((numNodes+numVS, numNodes+numVS), complex)
                    matrixB = np.zeros((numNodes+numVS,), complex)
                    # GND Equation
                    matrixM[0][0] = 1.0
                    # Resistor Equations
                    ...
                    try:
                        ...
                        print(pd.DataFrame(x, circuitNodes+circuitCurrents, columns=['Current / Voltage']))
                        print("The values given above are amplitude values.")
                    except np.linalg.LinAlgError:
                        sys.exit("Singular Matrix Formed! Please check if you have entered the circuit definition correctly!")
                except ValueError:
                    sys.exit("Netlist format error!")
